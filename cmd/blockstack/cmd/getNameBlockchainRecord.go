...
var getNameBlockchainRecordCmd = &cobra.Command{
	Use:   "get_name_blockchain_record",
	Short: "Calls the get_name_blockchain_record rpc method on the configured host",
...
func init() {
	...
	// getNameBlockchainRecordCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// getNameBlockchainRecordCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
